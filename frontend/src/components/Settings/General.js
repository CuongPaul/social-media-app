...
const General = () => {
  ...
  const handleClickUpdate = () => {
    handleUpdateProfile({
      ...
      hometown:
        fieldSelected === "Hometown" ? inputValue : currentUser?.hometown,
      education:
        fieldSelected === "Education" ? inputValue : currentUser?.education,
    });
    setIsOpen(false);
  };
  ...
  return (
    <Fragment>
      <Typography
        style={{ fontWeight: 800, fontSize: "24px", margin: "16px 0px" }}
      >
