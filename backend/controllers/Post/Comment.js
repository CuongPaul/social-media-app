...
import FilterCommentData from "../../utils/FilterCommentData";
import sendDataToFriends from "../../utils/socket/SendDataToFriend";
...
export const fetchComments = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ comments: filterComments, pagination: paginationData });
    } catch (err) {
        console.log(err);
        return res.status(500).json({ error: "Something went wrong" });
    }
